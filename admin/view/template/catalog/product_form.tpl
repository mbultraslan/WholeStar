        ...
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-product" class="form-horizontal">
          ...
          <div class="tab-content">
            ...
            <div class="tab-pane" id="tab-data">
              ...
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-ratioLabel"><span data-toggle="tooltip" title="Ratio Label eg. S-M-L or 12-14-16 use onlu dash (-)">Ratio Label</span></label>
                <div class="col-sm-10">
                  <input type="text" name="ratioLabel" value="<?php echo ratioLabel; ?>" placeholder="S-M-L or 12-14-18" id="input-ratioLabel" class="form-control" />
                </div>
              </div>
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-ratio">Ratio</label>
                <div class="col-sm-10">
                  <input type="text" name="ratio" value="<?php echo ratio; ?>" placeholder="Ratio" id="input-ratio" class="form-control" />
                </div>
              </div>
              <div id="colors">
                <div class="form-group" id="colorsBody">
                  ...
                  <div class="col-sm-10">
                    ...
                    <input type="text" name="colour[]"   class="form-control col-sm-2 color" style="width: 100px;" />
                    <label class="col-sm-2 control-label" >Name</label>
                    <input type="text" name="colourName[]"   class="form-control col-sm-2"  style="width: 100px;"/>
                    <label class="col-sm-2 control-label" >Pack</label>
                    <input type="text" name="colourPack[]"   class="form-control col-sm-2"  style="width: 100px;"/>
                  </div>
                </div>
                <div class="form-group">
              ...
              <script>
                function addNewColour(){
                  ...
                  var newElement =
                          ...
                          '<label class="col-sm-2 control-label" >Pack</label>'+
                          '<input type="text" name="colourPack[]"   class="form-control col-sm-2"  style="width: 100px;"/>'+
                          '<label class="btn btn-danger" style="float: right;" onclick="removeColour('+id+')" >Remove</label>'+
                          '</div>'+
                          '</div>';
