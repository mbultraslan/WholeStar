  ...
  <div class="page-header">
    ...
    <div class="container-fluid">
      ...
      <div class="pull-right">
      	...
      	<button type="button" id="button-shipping-status" form="form-order" formaction="<?php echo $shippingstatus; ?>" data-toggle="tooltip" title="<?php echo $button_shipping_status; ?>" class="btn btn-info"><i class="fa fa-truck"></i></button>
...
$('input[name^=\'selected\']').on('change', function() {
	...
	$('#button-shipping, #button-invoice, #button-shipping-status').prop('disabled', true);
	...
	for (i = 0; i < selected.length; i++) {
		...
		if ($(selected[i]).parent().find('input[name^=\'shipping_code\']').val()) {
			...
			$('#button-shipping, #button-shipping-status').prop('disabled', false);
...
$('#button-shipping-status').click(function(){
	var url = $(this).attr('formaction');
	var data = $( "form#form-order" ).serialize();
	...
	$.ajax({
		...
		success: function(json) {
			$('.container-fluid').find('.panel.panel-default').before(json);
		}
	});
});
//--></script></div>
