    ...
    <div class="page-header">
        <div class="container-fluid">
            <div class="pull-right">
                <a href="<?php echo $edit_template_url; ?>" class="btn btn-success"><i class="fa fa-plus-circle"></i> New template</a>
            </div>
            ...
            <div class="tab-content pr">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-4 col-md-2">
                        <div class="thumbnail">
                            <img src="<?php echo $template['cover']; ?>" alt="">
                            <div class="caption">
                                <h3><?php echo $template['name']; ?></h3>

                                <p><?php if($template['installed']) { ?><span class="label label-success">Installed</span><?php } ?></p>
                                <p>
                                    <?php if($template['installed']) { ?>
                                        <a class="btn btn-danger" href="<?php echo $templates_uninstall_url; ?>&id=<?php echo $template['id']; ?>"  href="#">Uninstall</a>
                                        <a class="btn btn-info" href="<?php echo $templates_edit_url; ?>&id=<?php echo $template['id']; ?>">Edit</a>
                                    <?php } else { ?>
                                        <a class="btn btn-success" href="<?php echo $templates_install_url; ?>&path_name=<?php echo $template['path_name']; ?>">Install</a>
                                    <?php } ?>
