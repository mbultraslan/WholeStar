...
<div id="content">
    ...
    <div class="container-fluid">
        ...
        <ul class="nav nav-tabs tab-size-bigger">
            ...
            <li class="active"><a href="<?php echo $tab_selling; ?>" ><i class="fa fa-shopping-cart bigger-130"></i> <span class="bigger-110"> My Selling</span></a></li>
                ...
                <div class="well action-bar">
                    ...
                    <div class="col-sm-10">
                        <div class="form-group">
                            <label class="control-label" >Find by ItemID</label>
                    ...
                    <div class="col-sm-2 pull-right">
                        <div class="form-group">
                            ...
                            <select name="pag" class="form-control"></select>
                        </div>
                        <button id="search-btn" type="button" id="button-filter" class="btn btn-primary pull-right"><i class="fa fa-search"></i> Search</button>
                    </div>


                    </div>
                </div>
                <table border="0" id="items_table" class="table table-striped table-bordered no-footer list" data-url="<?php echo $search_url; ?>" data-ebay-action="<?php echo $ebay_action_url; ?>" width="100%">
                    <thead>
                    <tr class="header-t">
                        <th><input id="selectall" type="checkbox"></th>
                        <th>Image</th>
                        <th class="center">Title</th>
                        <th class="center">eBay Price</th>
                        <th class="center">Local Price</th>
                        <th class="center">eBay Quantity</th>
                        <th class="center">Local Quantity</th>
