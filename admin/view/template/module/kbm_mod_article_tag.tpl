		...
		<div id="Module_{{module.row}}" class="vtabs-content">
			<table class="form">
				...
				<tr>
					...
					<td>
						<?php foreach ($languages as $language) { ?>
							<p>
								<input type="text" name="kbm_mod_article_tag[<?php echo $language['language_id']; ?>][title]"<?php if ($language['language_id'] == $config_language_id) { ?> class="ModuleTitle" data-module-row="{{module.row}}" data-shortcode="#ModuleShortCode_{{module.row}}" <?php } ?>value="<?php echo isset($kbm_mod_article_tag[$language['language_id']]['title']) ? $kbm_mod_article_tag[$language['language_id']]['title'] : ''; ?>" size="50" />
				...
				<tr>
					...
					<td>
						<input type="text" name="modulessort_order" value="{{module.sort_order}}" size="5" />
					</td>
				</tr>
			</table>
