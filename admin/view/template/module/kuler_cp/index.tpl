...
<div id="content">
	<section id="kuler-module-content" ng-app="kulerModule" ng-controller="ControlPanelCtrl" body>
					...
					<div class="panel" id="kuler-panel-action">
						<div class="panel-body">
							<div class="form-inline pull-left" id="panel-skin">
								...
								<button class="btn-kuler btn btn-danger" ng-if="canRemoveSkin();" ng-click="removeSkin()" tooltip="<?php echo _t('text_hint_remove_skin'); ?>"><?php echo _t('button_remove_skin', 'Remove Skin'); ?></button>
								<button class="btn-kuler btn btn-default" ng-click="exportSkins()" tooltip="<?php echo _t('text_hint_export_skins'); ?>"><?php echo _t('button_export_skins', 'Export Skins'); ?></button>
								<span class="btn-kuler btn btn-default btn-file" tooltip="<?php echo _t('text_hint_import_skins'); ?>">
							...
							<div class="pull-right main-actions">
								<div class="input-group">
									...
									<span class="input-group-btn">
										<button class="btn-kuler btn btn-default" type="button" ng-click="saveSkinAs()" tooltip="<?php echo _t('text_hint_save_skin_as'); ?>"><?php echo _t('button_save_skin_as', 'Save Skin As'); ?></button>
									</span>
								</div>
								<button class="btn-kuler btn btn-success" ng-click="save()"><i class="fa fa-check-circle-o"></i> <?php echo _t('button_save', 'Save'); ?></button>
								<button class="btn-kuler btn btn-danger" ng-click="cancel()"><i class="fa fa-times-circle"></i> <?php echo _t('button_cancel', 'Cancel'); ?></button>
							</div>
						</div>
					</div>
				</div>
					...
					<section class="panel" id="kuler-panel-navigation">
						<nav class="navbar" role="navigation" id="kuler-navbar-container">
							<div class="row">
								...
								<div class="col-sm-9" id="kuler-main-tab-list-container">
									<ul id="kuler-main-tab-list" class="nav navbar-nav" persistent-tab="kcp_section">
										...
										<li id="kuler-theme-links" class="dropdown">
											<a href class="dropdown-toggle"><?php echo _t('text_help', 'Help'); ?></a>
					...
					<section class="panel" id="kuler-panel-section">
						<div class="panel-body">
							<div id="tab-general" class="section-tab">
								<div class="row">
									<div class="col-sm-3">
										<ul class="nav nav-pills nav-stacked kuler-tab-list" persistent-tab="kcp_group_general">
									...
									<div class="col-sm-9 tab-container">
										...
										<fieldset>
											...
											<ul class="nav nav-tabs" persistent-tab="kcp_product_page_custom_block" role="tablist">
												<?php foreach ($languages as $language) { ?>
													<li data-target="#tab-custom-block-<?php echo $language['language_id']; ?>"><a><img src="view/image/flags/<?php echo $language['image']; ?>" title="<?php echo $language['name']; ?>"> <?php echo $language['name']; ?></a></li>
												<?php } ?>
											</ul>
											<?php foreach ($languages as $language) { ?>
										...
										<fieldset>
											...
											<ul class="nav nav-tabs" persistent-tab="kcp_product_page_custom_tab_1" role="tablist">
												<?php foreach ($languages as $language) { ?>
													<li data-target="#tab-custom-tab-1-<?php echo $language['language_id']; ?>"><a><img src="view/image/flags/<?php echo $language['image']; ?>" title="<?php echo $language['name']; ?>"> <?php echo $language['name']; ?></a></li>
												<?php } ?>
											</ul>
											<?php foreach ($languages as $language) { ?>
										...
										<fieldset>
											...
											<ul class="nav nav-tabs" persistent-tab="kcp_product_page_custom_tab_2" role="tablist">
												<?php foreach ($languages as $language) { ?>
													<li data-target="#tab-custom-tab-2-<?php echo $language['language_id']; ?>"><a><img src="view/image/flags/<?php echo $language['image']; ?>" title="<?php echo $language['name']; ?>"> <?php echo $language['name']; ?></a></li>
												<?php } ?>
											</ul>
											<?php foreach ($languages as $language) { ?>
										...
										<div id="tab-contact-page" class="tab-content">
											...
											<fieldset>
												...
												<ul class="nav nav-tabs" persistent-tab="kcp_contact_page_custom_information" role="tablist">
													<?php foreach ($languages as $language) { ?>
														<li data-target="#tab-custom-information-<?php echo $language['language_id']; ?>"><a><img src="view/image/flags/<?php echo $language['image']; ?>" title="<?php echo $language['name']; ?>"> <?php echo $language['name']; ?></a></li>
													<?php } ?>
												</ul>
												<?php foreach ($languages as $language) { ?>
										...
										<div id="tab-others" class="tab-content">
											...
											<fieldset>
												<legend><?php echo _t('text_custom_notification', 'Custom Nofification'); ?></legend>
												<?php echo renderOption(array(
							...
							<div id="tab-footer" class="section-tab">
								<div class="row">
									<div class="col-sm-3">
										<ul class="nav nav-pills nav-stacked kuler-tab-list" persistent-tab="kcp_group_footer">
									...
									<div class="col-sm-9 tab-container">
										<div id="tab-information" class="tab-content">
											...
											<ul class="nav nav-tabs" persistent-tab="kcp_information" role="tablist">
												<?php foreach ($languages as $language) { ?>
													<li data-target="#tab-information-<?php echo $language['language_id']; ?>"><a><img src="view/image/flags/<?php echo $language['image']; ?>" title="<?php echo $language['name']; ?>"> <?php echo $language['name']; ?></a></li>
												<?php } ?>
											</ul>
											<?php foreach ($languages as $language) { ?>
											...
											<filedset ng-controller="MailServiceCtrl">
												...
												<?php echo renderOption(array(
													...
													'html' => renderSelect(array(
															...
															'options' => array()
														)) . '<button class="btn-kuler btn btn-white btn-sm" ng-click="getLists(options.mail_service)" style="margin-right: 15px;">'. _t('button_get_contact_lists', 'Get Contact Lists') .'</button>' . _t('text_hint_contact_list')
												)); ?>
											</filedset>
										...
										<div id="tab-custom-copyright" class="tab-content">
											...
											<ul class="nav nav-tabs" persistent-tab="kcp_custom_copyright" role="tablist">
												<?php foreach ($languages as $language) { ?>
													<li data-target="#tab-custom-copyright-<?php echo $language['language_id']; ?>"><a><img src="view/image/flags/<?php echo $language['image']; ?>" title="<?php echo $language['name']; ?>"> <?php echo $language['name']; ?></a></li>
												<?php } ?>
											</ul>
											<?php foreach ($languages as $language) { ?>
										...
										<div id="tab-payment-icons" class="tab-content">
											...
											<table class="table" ng-controller="PaymentIconsCtrl">
												...
												<tfoot>
												<tr>
													<td colspan="100%"><button type="button" class="btn-kuler btn btn-success" ng-click="addPaymentIcon()"><?php echo _t('button_add_payment_icon', 'Add Payment Icon'); ?></button></td>
												</tr>
												</tfoot>
												<tbody>
												<tr ng-repeat="icon in icons">
													...
													<td><button type="button" class="btn-kuler btn btn-danger" ng-click="removePaymentIcon($index)"><?php echo _t('button_remove', 'Remove'); ?></button></td>
												</tr>
												</tbody>
											</table>
									...
									<div class="col-sm-12 clearfix">
										<div id="customize-controls" ng-class="{hiding: hiddenStylePanel}">
											<div id="customize-controls-actions">
												<button class="btn-kuler btn btn-success btn-sm btn-save" ng-click="save();"><?php echo _t('button_save'); ?></button>
												<button class="btn-kuler btn btn-danger btn-sm" ng-click="cancelStyleCustomization();"><?php echo _t('button_cancel'); ?></button>
											</div>
											...
											<div id="customize-controls-second-actions">
												<span class="pull-right btn-collapse" ng-click="toggleStylePanel()"><span class="fa" ng-class="{'fa-arrow-circle-left': !hiddenStylePanel, 'fa-arrow-circle-right': hiddenStylePanel}"></span> <span class="btn-kuler btn-collapse-text"><?php echo _t('button_collapse', 'Collapse'); ?></span></span>
											</div>
										</div>
							...
							<div id="tab-custom-code" class="section-tab">
								<div class="row">
									<div class="col-sm-3">
										<ul class="nav nav-pills nav-stacked kuler-tab-list" persistent-tab="kcp_group_custom_code">
		...
		<iframe ng-src="{{download_url}}" class="kuler-download-frame"></iframe>
	</section>
	<script>
		var Kuler = {
