<?php echo $header; ?><?php echo $column_left; ?>
	<div id="content" class="kuler-module">
		...
		<?php } ?>
		<?php if ($success) { ?>
			<div class="success" style="margin-top: 15px;color:rgb(45, 221, 54)"><?php echo $success; ?></div>
		<?php } ?>
		<div class="box">
			<div class="heading clearafter">
				<h1 class="col-sm-9"><img src="./view/kulercore/images/logos/kbm.png" alt="<?php echo _t('heading_module_title'); ?>" /></h1>
			...
			<div class="content">
				<form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
					...
					<div style="margin: 20px 0 0 30px; display:none">
					...
					<ul id="ModuleTabItems" class="vtabs col-sm-3" style="display: none">
	...
	<div id="Module_{{module.row}}" class="vtabs-content">
		<table class="form">
			<tr>
				<td><?php echo _t('entry_module_name'); ?></td>
				<td>
					<input type="text" name="name" value="{{module.name}}" size="20" />
				</td>
			</tr>
			<tr>
				<td><?php echo _t('entry_show_status'); ?></td>
				<td>
					<div class="kuler-switch-btn">
						<input type="hidden" name="status" value="0" />
						<input type="checkbox" name="status" value="1"{{#compare module.show_title 1}} checked="checked"{{/compare}} />
			...
			<tr>
				...
				<td>
					<div class="kuler-switch-btn">
						...
						<input type="checkbox" name="show_title" value="1"{{#compare module.show_title 1}} checked="checked"{{/compare}} />
						<span class="kuler-switch-btn-holder"></span>
					</div>
				</td>
			</tr>
			<tr>
				...
				<td>
					<?php foreach ($languages as $language) { ?>
						<p>
							<input type="text" name="kbm_mod_recent_article_module[<?php echo $language['language_id']; ?>][title]"<?php if ($language['language_id'] == $config_language_id) { ?> class="ModuleTitle" data-module-row="{{module.row}}" data-shortcode="#ModuleShortCode_{{module.row}}" <?php } ?>value="<?php echo isset($kbm_mod_recent_article_module[$language['language_id']]['title']) ? $kbm_mod_recent_article_module[$language['language_id']]['title'] : ''; ?>" size="50" />
			...
			<tr>
				...
				<td>
					<input type="text" id="ModuleShortCode_{{module.row}}" class="ModuleShortCode" name="shortcode" value="{{module.shortcode}}" readonly="readonly" size="40" />
				</td>
			</tr>
			<tr>
				<td><?php echo _t('entry_sort_order'); ?></td>
				<td>
					<input type="text" name="sort_order" value="{{module.sort_order}}" size="5" />
				</td>
			</tr>
		</table>
		...
		<table class="form">
			<tr>
				...
				<td>
					<div class="kuler-switch-btn">
						<input type="hidden" name="product_featured_image" value="0" />
						<input type="checkbox" name="product_featured_image" value="1"{{#compare module.product_featured_image 1}} checked="checked"{{/compare}} />
						<span class="kuler-switch-btn-holder"></span>
					</div>
				</td>
			</tr>
			<tr>
				...
				<td>
					<div class="kuler-switch-btn">
						<input type="hidden" name="product_description" value="0" />
						<input type="checkbox" name="product_description" value="1"{{#compare module.product_description 1}} checked="checked"{{/compare}} />
						<span class="kuler-switch-btn-holder"></span>
					</div>
				</td>
			</tr>
					...
					<div class="scrollbox">
						...
						<?php foreach ($category_options as $category_id => $category_name) { ?>
							<div class="<?php echo $category_index % 2 ? 'odd' : 'even'; ?>">
								<input type="checkbox" name="specific_categories[]" value="<?php echo $category_id; ?>"{{#inArray <?php echo $category_id; ?> module.specific_categories}} checked="checked"{{/inArray}} />
			...
			<tr>
				...
				<td>
					<div class="scrollbox">
						...
						<?php foreach ($category_options as $category_id => $category_name) { ?>
							<div class="<?php echo $category_index % 2 ? 'odd' : 'even'; ?>">
								<input type="checkbox" name="exclude_categories[]" value="<?php echo $category_id; ?>"{{#inArray <?php echo $category_id; ?> module.exclude_categories}} checked="checked"{{/inArray}} />
								<?php echo $category_name; ?>
							</div>
							<?php $category_index++; ?>
						<?php } ?>
			...
			<tr>
				...
				<td>
					<input type="text" name="article_limit" value="{{module.article_limit}}" size="5" />
				</td>
			</tr>
			<tr>
				<td><?php echo _t('entry_description_limit'); ?></td>
				<td>
					<input type="text" name="description_limit" value="{{module.description_limit}}" size="5" />
				</td>
			</tr>
			<tr>
				<td><?php echo _t('entry_featured_image_size'); ?></td>
				<td>
					<input type="text" name="featured_image_width" value="{{module.featured_image_width}}" size="5" /> x
					<input type="text" name="featured_image_height" value="{{module.featured_image_height}}" size="5"/>
