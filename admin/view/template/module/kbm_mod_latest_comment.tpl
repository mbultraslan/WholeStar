		...
		<div id="Module_{{module.row}}" class="vtabs-content">
				...
				<tr>
					...
					<td>
						<?php foreach ($languages as $language) { ?>
							<p>
								<input type="text" name="kbm_mod_latest_comment[<?php echo $language['language_id']; ?>][title]"<?php if ($language['language_id'] == $config_language_id) { ?> class="ModuleTitle" data-module-row="{{module.row}}" data-shortcode="#ModuleShortCode_{{module.row}}" <?php } ?>value="<?php echo isset($kbm_mod_latest_comment[$language['language_id']]['title']) ? $kbm_mod_latest_comment[$language['language_id']]['title'] : ''; ?>" size="50" />
			...
			<table class="form">
				...
				<tr>
					...
					<td>
						<input type="text" name="limit" value="{{module.limit}}" size="5" />
					</td>
				</tr>
				<tr>
					<td><?php echo _t('entry_avatar_image_size'); ?></td>
					<td>
						<input type="text" name="avatar_size" value="{{module.avatar_size}}" size="5" />
