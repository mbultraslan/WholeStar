        ...
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-newsletter" class="form-horizontal">
          <div class="form-group">
            ...
            <div class="col-sm-10">
			  ...
			  <select name="newslettersubscribe_unsubscribe" class="form-control" >
		  ...
		  <div class="form-group">
            <label class="col-sm-2 control-label" for="input-name"><?php echo $entry_registered; ?>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <select name="newslettersubscribe_status" id="input-status" class="form-control">
