				...
				<tr>
					...
					<td>
						<?php foreach ($languages as $language) { ?>
							<p>
								<input type="text" name="kbm_mod_popular_article[<?php echo $language['language_id']; ?>][title]"<?php if ($language['language_id'] == $config_language_id) { ?> class="ModuleTitle" data-module-row="{{module.row}}" data-shortcode="#ModuleShortCode_{{module.row}}" <?php } ?>value="<?php echo isset($kbm_mod_popular_article[$language['language_id']]['title']) ? $kbm_mod_popular_article[$language['language_id']]['title'] : ''; ?>" size="50" />
