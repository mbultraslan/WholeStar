		...
		<div id="Module_{{module.row}}" class="vtabs-content">
				...
				<tr>
					...
					<td>
						<?php foreach ($languages as $language) { ?>
							<p>
								<input type="text" name="kbm_mod_category[<?php echo $language['language_id']; ?>][title]"<?php if ($language['language_id'] == $config_language_id) { ?> class="ModuleTitle" data-module-row="{{module.row}}" data-shortcode="#ModuleShortCode_{{module.row}}" <?php } ?>value="<?php echo isset($kbm_mod_category[$language['language_id']]['title']) ? $kbm_mod_category[$language['language_id']]['title'] : ''; ?>" size="50" />
			...
			<table class="form">
				...
				<tr>
					...
					<td>
						<div class="kuler-switch-btn">
							<input type="hidden" name="article_count" value="0" />
							<input type="checkbox" name="article_count" value="1"{{#compare module.article_count 1}} checked="checked"{{/compare}} />
							<span class="kuler-switch-btn-holder"></span>
						</div>
					</td>
				</tr>
