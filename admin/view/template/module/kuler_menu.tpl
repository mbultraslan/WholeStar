						...
						<div class="col-sm-12">
							<section class="panel" id="kuler-panel-navigation">
								<nav class="navbar" role="navigation" id="kuler-navbar-container">
									...
									<div class="kuler-navigation-right stylemenu" id="kuler-navigation-space"></div>
								</nav>
							</section>

							<section class="panel" id="kuler-panel-section">
								<div class="panel-body">
									<div vertical="true" main-tab="true" type="pills" id="kuler-module-container" class="clearfix ng-isolate-scope backgroundmenu">
										<ul class="nav nav-pills nav-stacked enabletabmodule" id="ModuleTabItems"></ul>
										<div class="tab-content tabmenu" id="ModuleContainer">
	...
	<script id="OptionProductTemplate" type="text/x-handlebars-template">
		<div class="form-horizontal">
			...
			<fieldset>
				...
				<div class="form-group">
					<label class="col-sm-2 control-label"><?php echo _t('entry_product_per_row'); ?></label>
					<div class="col-sm-2">
						<input type="text" class="form-control" name="menus[{{menu.row}}][product_per_row]" value="{{menu.product_per_row}}" size="5" />
					</div>
				</div>
				<div class="form-group">
