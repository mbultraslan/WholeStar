...
<?php
function languageImage($data) {
    if (version_compare(VERSION, '2.2.0.0') < 0) {
        $img_src = 'view/image/flags/' . $data['image'];
    } else {
        $img_src = 'language/' . $data['code'] . '/' . $data['code'] . '.png';
    }
    return $img_src;
}
?>
<div id="content">
    ...
    <link rel="stylesheet" media="screen" type="text/css" href="view/javascript/colorpicker/css/bootstrap-colorpicker.min.css" />
                    ...
                    <div class="tab-content">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="left">
                                            ...
                                            <div class="input-group">
                                                <span class="input-group-addon" id="basic-addon1"><img class="left" src="<?php $src =languageImage($language); echo $src; ?>" title="<?php echo $language['name']; ?>" /></span>
                                                <input class="form-control" style="width:97%" name="langs[warning_non_address_shipping][<?php echo $language['language_id'];?>]" value="<?php echo isset($langs['warning_non_address_shipping'][$language['language_id']]) ? $langs['warning_non_address_shipping'][$language['language_id']]:'You must apply an address for calculating fee!'?>"/>
                                            </div>
                                            <?php } ?>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td  class="left">
                                            ...
                                            <div class="input-group">
                                                <span class="input-group-addon" id="basic-addon1"><img class="left" src="<?php $src =languageImage($language); echo $src; ?>" title="<?php echo $language['name']; ?>" /></span>
                                                <input class="form-control" style="width:97%" name="langs[warning_non_address_payment][<?php echo $language['language_id'];?>]" value="<?php echo isset($langs['warning_non_address_payment'][$language['language_id']]) ? $langs['warning_non_address_payment'][$language['language_id']]:'You must apply an address for showing payment method !'?>" />
                                            </div>
                                            <?php } ?>
                                        </td>
                                    </tr>
                            ...
                            <div class="tab-content">
                                ...
                                <div id="custom_styles" style="margin-bottom: 200px;" class="tab-pane">
                                    ...
                                    <div>
                                        ...
                                        <table class="table table-hover table-bordered" id="tbl-button-styles" style="display: none;">
                                            <thead>
                                                <tr>
                                                    <td colspan="4"  class="text-left"><?php echo $text_button_color_style;?>  
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <div class="input-group color-picker">
                                                            ...
                                                            <span class="input-group-addon"><i>fdfdf</i></span>
                                                        </div>
                                                        <input type="text" class="color-picker" id="color-picker1" style="background-color:<?php echo $css['common_btn_color']; ?>"/><br><strong><?php echo $css['common_btn_color']; ?></strong>
                                                    </td>
                                                    <td>
                        ...
                        <div class="tab-pane" id="tab-tips-setting" >
                            <ul id="tips-languages" class="nav nav-tabs">
                                ...
                                <li class="<?php if ($i == 0) echo 'active' ?> " >
                                    <a href="#tips-language<?php echo $language['language_id']; ?>" data-toggle="tab"><img src="<?php $src =languageImage($language); echo $src; ?>" title="<?php echo $language['name']; ?>" /> <?php echo $language['name']; ?></a>
                                </li>
                                <?php $i++; ?>
                                <?php } ?>
                            </ul>
                        ...
                        <div class="tab-pane" id="tab-langs-setting" >
                            <ul id="langs-languages" class="nav nav-tabs">
                                ...
                                <?php foreach ($languages as $language) { ?>
                                <li class="<?php if ($i == 0) echo 'active' ?> " >
                                    <a href="#langs-language<?php echo $language['language_id']; ?>" data-toggle="tab"><img src="<?php $src =languageImage($language); echo $src; ?>" title="<?php echo $language['name']; ?>" /> <?php echo $language['name']; ?></a>
                                </li>
                                <?php $i++; ?>
                                <?php } ?>
                            </ul>
                                    ...
                                    <table class="table">
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>
                                                    <input type="text" class="form-control" name="langs[make_order_button][<?php echo $language['language_id']; ?>]"  value="<?php echo (!empty($langs['make_order_button'][$language['language_id']])) ?  $langs['make_order_button'][$language['language_id']] : ' Preview order'; ?>"/>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td class="col-sm-2 text-right">
                                                    <div class="">
                                                        <label class="control-label"><?php echo $text_text_alert_register;?></label>
                                                    </div>
                                                </td>
                                                <td>
                                                    <input type="text" class="form-control" name="langs[text_alert_register][<?php echo $language['language_id']; ?>]"  value="<?php echo  (!empty($langs['text_alert_register'][$language['language_id']]))  ?  $langs['text_alert_register'][$language['language_id']] : 'You should register before order'; ?>"/>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td class="col-sm-2 text-right">
                                                ...
                                                <td>
                                                    <input type="text" class="form-control" name="langs[edit_order_button][<?php echo $language['language_id']; ?>]"  value="<?php echo (!empty($langs['edit_order_button'][$language['language_id']])) ?  $langs['edit_order_button'][$language['language_id']] : 'Edit Order'; ?>"/>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td class="col-sm-2 text-right">
                                                ...
                                                <td>
                                                    <input type="text" class="form-control" name="langs[no_shipping_required][<?php echo $language['language_id']; ?>]"  value="<?php echo (!empty($langs['no_shipping_required'][$language['language_id']])) ?  $langs['no_shipping_required'][$language['language_id']] : ''; ?>"/>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td class="col-sm-2 text-right">
                                                    <div class="">
                                                        <label class="control-label"><?php echo $text_common_button_ok;?></label>
                                                    </div>
                                                </td>
                                                <td>
                                                    <input type="text" class="form-control" name="langs[button_ok][<?php echo $language['language_id']; ?>]"  value="<?php echo (!empty($langs['button_ok'][$language['language_id']])) ?  $langs['button_ok'][$language['language_id']] : 'Apply address'; ?>"/>
                                                </td>
                                            </tr>
                                        </tbody>
                                    </table>
