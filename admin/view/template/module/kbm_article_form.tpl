            ...
            <div class="vtabs-content">
                ...
                <form action="<?php echo $action; ?>" method="post" id="form">
                        ...
                        <table class="form">
                                ...
                                <td>
	                                <div class="col-sm-4">
		                                <div class="input-group date">
			                                <input type="text" name="article[article][date_added]" value="<?php echo $article['article']['date_added_formatted']; ?>"  data-format="YYYY-MM-DD HH:mm" id="input-date-available" class="form-control" />
                            ...
                            <tr>
                                ...
                                <td>
	                                <div class="col-sm-4">
		                                <div class="input-group date">
			                                <input type="text" name="article[article][date_modified]" value="<?php echo $article['article']['date_modified_formatted']; ?>"  data-format="YYYY-MM-DD HH:mm" id="input-date-available" class="form-control" />
						                    <span class="input-group-btn">
						                    <button class="btn btn-default" type="button"><i class="fa fa-calendar"></i></button>
						                    </span>
		                                </div>
                            ...
                            <tr>
                                ...
                                <td>
	                                <div class="col-sm-4">
		                                <div class="input-group date">
			                                <input type="text" name="article[article][date_published]" value="<?php echo $article['article']['date_published_formatted']; ?>"  data-format="YYYY-MM-DD" id="input-date-available" class="form-control" />
						                    <span class="input-group-btn">
						                    <button class="btn btn-default" type="button"><i class="fa fa-calendar"></i></button>
						                    </span>
		                                </div>
                            ...
                            <tr>
                                ...
                                <td>
	                                <a href="" id="thumb-image" data-toggle="image" class="img-thumbnail"><img src="<?php echo $article['thumb']; ?>" alt="" title="" data-placeholder="<?php echo $placeholder; ?>" /></a>
	                                <input type="hidden" name="article[article][featured_image]" value="<?php echo $article['article']['featured_image']; ?>" id="FeaturedImage" />
                                </td>
                            </tr>
                            <tr>
                    ...
                    <div id="ProductDesign">
	                    <p class="help" style="color: #DF3525;"><?php echo _t('text_article_hint_layout_override', 'Layout Override requires VQMOD installed.'); ?></p>
                        <table class="list">
                            <thead>
                            <tr>
