...
<div id="content" class="kuler-module">
    ...
    <div class="box">
        <div class="heading clearafter">
            <h1 class="col-sm-8"><img src="./view/kulercore/images/logos/kbm.png" alt="<?php echo _t('heading_module_title'); ?>" /></h1>
            ...
            <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
                ...
                <div class="vtabs-content">
                    <div class="htabs">
                        ...
                        <a href="#SEO" class="SettingTab" id="SettingTab_6" data-tab="6"><?php echo _t('text_seo', 'SEO'); ?></a>
                        ...
                        <table class="form">
                            <tr>
                                ...
                                <td>
                                    ...
                                    <?php } ?>
	                                <p class="help"><?php echo _t('text_settings_hint_articles_per_page', 'Number of articles displayed at article category page.'); ?></p>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <?php } ?>
	                                <p class="help"><?php echo _t('text_settings_hint_article_chracters', 'Maximum number of article description at article category page. '); ?></p>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <?php } ?>
	                                <p class="help"><?php echo _t('text_settings_hint_featured_image_size', 'Dimension of article image at article category page.'); ?></p>
                                </td>
                            </tr>
                        </table>
                    </div>
                        ...
                        <table class="form">
                            <tr>
                                ...
                                <td>
	                                ...
	                                <p class="help"><?php echo _t('text_settings_hint_article_info', 'Show article information at article page.'); ?></p>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
	                                ...
	                                <p class="help"><?php echo _t('text_settings_hint_article_at_article_page', 'Show related articles at article page.'); ?></p>
                                </td>
                            </tr>
	                        <tr>
                        ...
                        <table class="form">
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <?php } ?>
	                                <p class="help"><?php echo _t('text_settings_hint_min_max_character', 'Require minimum and maximum length of characters when comment.'); ?></p>
                                </td>
                            </tr>
                            <tr>
                                <td><?php echo _t('entry_comment_order'); ?></td>
                                <td>
                                    <select name="setting[comment][comment_order]" style="width: 200px;">
                            ...
                            <tr>
                                ...
                                <td>
	                                ...
	                                <p class="help"><?php echo _t('text_settings_hint_email_notification', 'Module will send notification for this email when user comments in a article.') ?></p>
                                </td>
                            </tr>
                            <tr>
                                <td><?php echo _t('entry_captcha', 'Captcha'); ?></td>
                                <td>
                                    <select name="setting[comment][captcha]" style="width: 300px;">
	                                ...
	                                <p class="help"><?php echo _t('text_settings_hint_captcha', 'Enable captcha when comment.'); ?></p>
                                </td>
                            </tr>
                        </table>
                    ...
                    <div id="SearchAndFeedsSetting">
	                    ...
	                    <p class="help"><?php echo _t('text_settings_hint_blog_feed_link', 'Blog Feed Link'); ?>: <a href="http://{your_site}/?route=module/kbm/feed">http://{your_site}/?route=module/kbm/feed</a></p>
                        <table class="form">
                            <tr>
                            ...
                            <tr>
                                ...
                                <td>
	                                ...
	                                <p><?php echo _t('text_settings_hint_blog_feed_limit', 'Maximum number of items displayed in feed.'); ?></p>
                                </td>
                            </tr>
                        </table>

                        <h2><?php echo _t('text_sitemap_setting'); ?></h2>
	                    <p class="help"><?php echo _t('text_settings_hint_sitemap_link', 'Sitemap Link'); ?>: <a href="http://{your_site}/?route=module/kbm/sitemap">http://{your_site}/?route=module/kbm/sitemap</a></p>
                        <table class="form">
                            <tr>
                            ...
                            <tr>
                                ...
                                <td>
	                                ...
	                                <p><?php echo _t('text_settings_hint_blog_sitemap_limit', 'Maximum number of items displayed in sitemap.'); ?></p>
                                </td>
                            </tr>
                        </table>
                    </div>
                    ...
                    <div id="SEO">
	                    <p class="help" style="color: #DF3525;"><?php echo _t('text_settings_hint_seo', 'SEO feature requires <a href="https://code.google.com/p/vqmod/" target="_blank">VQMOD</a> installed and enable <b>Use SEO URL\'s</b> in your site settings first.'); ?></p>
	                    
	                    <table class="form">
		                    <tr>
			                    <td><?php echo _t('entry_enable_seo', 'Enable SEO'); ?></td>
			                    <td>
				                    <div class="kuler-switch-btn">
				                    ...
				                    <p class="help"><?php echo _t('text_settings_hint_enable_seo', 'Enable SEO for Kuler Blog Manager.'); ?></p>
			                    </td>
		                    </tr>
		                    <tr>
			                    <td><?php echo _t('entry_blog_url_prefix', 'Blog URL Prefix'); ?></td>
			                    <td>
				                    ...
				                    <p class="help"><?php echo _t('text_settings_hint_blog_url_prefix', 'Prefix for all url of blog if SEO is enabled, for example: http://example.com/<b>blog</b>/this-is-article.html'); ?></p>
			                    </td>
		                    </tr>
		                    <tr>
			                    <td><?php echo _t('entry_exclude_categories', 'Exclude Categories'); ?></td>
			                    <td>
				                    <p class="help"><?php echo _t('text_settings_hint_exclude_categories', 'Disable SEO feature in below selected article categories.'); ?></p>
				                    <div class="scrollbox">
					                    <?php $category_index = 0; ?>
					                    <?php foreach ($category_options as $category_id => $category_name) { ?>
						                    <div class="<?php echo $category_index % 2 ? 'odd' : 'even'; ?>">
	                    ...
	                    <h2><?php echo _t('text_aritcle_seo', 'Article SEO'); ?></h2>
	                    <table class="form">
		                    <tr>
			                    ...
			                    <td>
				                    ...
				                    <p class="help"><?php echo _t('text_settings_hint_seo_url_prefix', 'Suffix after SEO article url, for example: http://example.com/blog/this-is-article<b>.html</b>'); ?></p>
			                    </td>
		                    </tr>
	                    </table>
                    </div>
                        ...
                        <table class="form">
                            <tr>
                                ...
                                <td>
                                    ...
                                    <?php } ?>
	                                <p class="help"><?php echo _t('text_settings_hint_articles_per_page', 'Number of articles displayed in article list management page.'); ?></p>
                                </td>
                            </tr>
                        </table>
                    </div>
