                ...
                <div class="vtabs-content">
                    ...
                    <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
                            ...
                            <table class="form">
                                ...
                                <tr>
                                    ...
                                    <td>
	                                    ...
	                                    <input type="hidden" name="category[category][image]" value="<?php echo $category['category']['image']; ?>" id="CategoryImage" />
	                                    <a href="" id="thumb-image" data-toggle="image" class="img-thumbnail"><img src="<?php echo $category['thumb']; ?>" alt="" title="" data-placeholder="<?php echo $placeholder; ?>" /></a>
                                    </td>
                                </tr>
                                <tr>
                        ...
                        <div id="CategoryDesign">
	                        ...
	                        <p class="help" style="color: #DF3525;"><?php echo _t('text_category_hint_layout_override', 'Layout Override requires VQMOD installed.'); ?></p>
                            <table class="list">
                                <thead>
                                <tr>
