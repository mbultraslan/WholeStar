...
defined('H2O_ROOT') or define('H2O_ROOT', '');
...
class H2o {
    ...
    function __construct($templateSource = null, $options = array()) {
        # Init a environment
        ...
        if (is_object($loader)) {
            ...
            $this->loader = new $loader($templateSource, $this->options);
        }
        ...
        //if ($file) {
            $this->nodelist = $this->loadTemplate($templateSource);
        //}
    }

    function loadTemplate($templateSource) {
       // return $this->nodelist = $this->loader->read_cache($file);
       return $this->nodelist = $this->loader->readTemplateString($templateSource);
