...
<?php
class RelistFixedPriceItemCall extends BaseCall {
	...
	public function relistItem($itemId, $product, $profile, $settings = array()) {
	    $requestXmlBody = '<?xml version="1.0" encoding="utf-8" ?>';
	    $requestXmlBody .= '<RelistFixedPriceItemRequest xmlns="urn:ebay:apis:eBLBaseComponents">';
	    ...
	    $requestXmlBody .= "</RelistFixedPriceItemRequest>";
