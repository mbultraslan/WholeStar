...
class ModelKulerCp extends Model
{
	...
	public function getThemeId($store_id)
	{
		...
		return is_array($settings) && isset($settings['kuler_cp_theme_id']) ? $settings['kuler_cp_theme_id'] : null;
	}
	...
	public function getSkinId($store_id)
	{
		...
		return is_array($settings) && isset($settings['kuler_cp_skin_id']) ? $settings['kuler_cp_skin_id'] : null;
	}
	...
	public function setSkinForStore($store_id, $theme_id, $skin_id)
	{
		$this->model_setting_setting->editSetting('kuler_cp', array(
			'kuler_cp_theme_id' => $theme_id,
			'kuler_cp_skin_id' => $skin_id
		), $store_id);
	}
