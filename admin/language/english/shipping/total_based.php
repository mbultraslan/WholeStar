...
$_['help_cart_criteria']				= '&bull; Enter a minimum value (such as 5.00) or a range (such as 3.3-10.5) that the cart or individual items must meet. A single value indicates <b>at least</b> that value. For example, if you set a criteria of 5.00, any value of 5.00 or more will be eligible.<br /><br />&bull; Ranges are inclusive of the end values. Separate multiple ranges using commas. To specify an exact value, use a range like 5.00-5.00. <br /><br />&bull; Values are normally compared only against eligible items (i.e. those that qualify for the charge based on other rules). To compare values against all items in the cart, including ineligible ones, choose a comparison containing "entire cart".';
