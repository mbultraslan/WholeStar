...
$_['heading_welcome']					= 'Welcome to the ' . $_['heading_title'] . ' Payment Gateway!';
$_['help_first_time']					= '
...
$_['entry_charge_mode']					= 'Charge Mode: <div class="help-text">Choose whether to authorize payments and manually capture them later, or to both authorize and capture (i.e. fully charge) payments when orders are placed. You can capture a payment that is only Authorized by using the link provided in the History tab for the order.</div>';
