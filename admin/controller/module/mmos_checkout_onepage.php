...
//WWw.MMOsolution.com config data -- DO NOT REMOVE--- 
        ...
        $view_data['text_text_alert_register'] = $this->language->get('text_text_alert_register');
...
#STORE
        ...
        if (version_compare(VERSION, '2.0.3.1') > 0) {
            ...
            $view_data['customer_groups'] = $this->model_customer_customer_group->getCustomerGroups();
        } else {
