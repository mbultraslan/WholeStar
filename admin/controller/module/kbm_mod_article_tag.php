...
class ControllerModuleKBMModArticleTag extends Controller
{
	...
	public function index()
	{
		...
		if (!empty($this->request->get['module_id'])) {
			$this->data['action'] = $this->url->link('module/kbm_mod_article_tag', 'token=' . $this->session->data['token'] . '&module_id='. $this->request->get['module_id']  , 'SSL');
		...
		if (isset($this->request->post['kbm_mod_article_tag'])) {
			$this->data['kbm_mod_article_tag'] = $this->request->post['kbm_mod_article_tag'];
		} elseif (!empty($module_info)) {
			$this->data['kbm_mod_article_tag'] = $module_info['kbm_mod_article_tag'];
		} else {
			$this->data['kbm_mod_article_tag'] = '';
		}
		...
		$this->response->setOutput($this->load->view('module/kbm_mod_article_tag.tpl', $this->data));
	}
	...
	private function save()
	{
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {
			...
			if (!isset($this->request->get['module_id'])) {
				$this->model_extension_module->addModule('kbm_mod_article_tag', $data);
		...
		{
			$this->response->redirect($this->url->link('module/kbm_mod_article_tag', 'token=' . $this->session->data['token'] . '&module_id=' . $module_id, 'SSL'));
		}
	}
