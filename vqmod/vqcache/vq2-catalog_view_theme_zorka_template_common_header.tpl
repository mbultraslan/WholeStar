...
?>
          ...
          <div id="logo">
            <?php if ($logo) { ?>
              <a href="<?php echo $home; ?>">
                <img style="width: 160%; max-width: 450px;" src="<?php echo $logo; ?>" title="<?php echo $name; ?>" alt="<?php echo $name; ?>" />
              </a>
            <?php } else { ?>
  ...
  <div id="search-inner" class="search-inner open">
    <input class="<?php echo $search_in_category ? 'category' : 'no-category' ?> kf_search" type="text" name="search" placeholder="Search..." />
          ...
          <div class="container">
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
              <ul class="mainmenu">
                ...
                <li class="item"><a href="<?php echo $home; ?>" <?php if ($kuler->getSkinOption('home_icon_type') == 'icon') { ?> class="home-icon" <?php } ?>><?php echo $kuler->language->get('text_home') ?></a></li>
