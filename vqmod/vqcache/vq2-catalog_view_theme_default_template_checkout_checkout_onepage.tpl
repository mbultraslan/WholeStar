...
<?php if(isset($mmos_checkout['enable_qtip']) && $mmos_checkout['enable_qtip'] == 1 ) { ?>
...
<style>
    ...
    #mmosolution .table-bordered > thead > tr > th, #mmosolution .table-bordered > tbody > tr > th, #mmosolution .table-bordered > tfoot > tr > th, #mmosolution .table-bordered > thead > tr > td, #mmosolution .table-bordered > tbody > tr > td, #mmosolution .table-bordered > tfoot > tr > td {
    vertical-align: middle;
}


    #payment-address  button#button-guest, #payment-address button#button-register, button#login-form #button-login {
        margin-bottom: -15px !important;
    }
    
    #mmosolution .list-group-item.active, #mmosolution .list-group-item.active:hover, #mmosolution .list-group-item.active:focus {
    z-index: 2;
    color: #fff;
...
<div id="checkout-wait-notification" class="mmosolution-popup-overlay hidden" >
    <div class="mmosolution-popup">
		<div  class="wait-processing-onepage"></div>
	</div>
</div>
</div>
<div <?php echo ($config_template == 'journal2') ?  'id="container" class="container j-container"'  : 'class="container"' ?>>
    <ul class="breadcrumb">
    ...
    <div class="row">
        ...
        <div id="content" class="<?php echo $class; ?>">
            ...
            <?php } ?>
            <div id="mmosolution">
                <div class="panel 1panel-<?php echo $classtheme; ?>" id="checkout-panel" style="<?php echo (!empty($css['checkout_panel_color'])) ?  "border-color:{$css['checkout_panel_color']}!important;" : '';?>">
                             ...
                             <div class="row">
                                 ...
                                 <h1>
                                     ...
                                     <button id='button-reload'  type="button" class="btn btn-default"
                                             ...
                                             <?php } ?>
                                             <i class="fa fa-flash" style="font-size: 36px;"></i> <?php echo $heading_title; ?>
                                     </h1>
        ...
        <script type="text/javascript"><!--
            ...
            var jqxhr = $.ajax({
            type: 'get',
                    url: 'index.php?route=checkout/confirm_onepage',
                    dataType: 'html',
            ...
            url: 'index.php?route=checkout/login_onepage/set_account_view',
                    ...
                    $(document).on('click', '#checkout-options .list-group-item', function(){
