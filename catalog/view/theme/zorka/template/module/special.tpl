      ...
      <div class="product-thumb transition">
        <div class="image">
          <a href="<?php echo $product['href']; ?>">
            ...
            <div class="category-product-info" style="position: absolute; margin-top: 0px; display: none; bottom: 185px; ">Style : <?php echo $product['model']; ?><br>Size : <?php echo $product['ratioScale']; ?><br>Ratio : <?php echo $product['ratio']; ?></div>
          </a>
