                        ...
                        <div class="form-group">
                            <div class="col-xs-12">
                                ...
                                <span class="input-group-btn">
                                    <button id="apply-reward" class="btn" type="button" style="<?php
                    ...
                    <div class="form-group">
                        ...
                        <div class="<?php echo  $couponclass; ?> col-xs-12">
                            <div class="input-group input-group-sm">
                                ...
                                <span class="input-group-btn">
                                    <button id="apply-voucher" class="btn" type="button" style="<?php
                                            if (!empty($css['voucher_coupon_btn_color'])) {
                                                echo "background-color:{$css['voucher_coupon_btn_color']}!important;background-image:none;";
                                            }
                                            ?>">
                        ...
                        <div class="<?php echo  $couponclass; ?> col-xs-12">
                            <div class="input-group  input-group-sm">
                                ...
                                <span class="input-group-btn">
                                    <button id="apply-coupon" class="btn" type="button"style="<?php
                                            if (!empty($css['voucher_coupon_btn_color'])) {
                                                echo "background-color:{$css['voucher_coupon_btn_color']}!important;background-image:none;";
                                            }
                                            ?>">
