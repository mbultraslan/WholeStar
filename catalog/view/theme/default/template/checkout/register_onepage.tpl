    ...
    <div class="panel-body"  style="border-left: 0">
        <form role="form">
            ...
            <fieldset id="account-register">
                <legend class="text-<?php echo $classtheme ; ?>"><i class="fa fa-user"  style="font-size: 1.3em;"></i>&nbsp;<?php echo $text_your_details; ?></legend>
                ...
                <?php } else { ?>
                <div style="display: <?php echo (count($customer_groups) > 1 ? 'block' : 'none'); ?>;" class="form-group form-group-sm mmos-customer_group_id">
                    <legend class="text-success" style="font-size: 18px;"><i class="fa fa-users"></i> <?php echo $entry_customer_group; ?></legend>
                    <div>
                        <strong>
                ...
                <div class="form-group form-group-sm required mmos-firstname">
                ...
                <div class="form-group form-group-sm required mmos-lastname">
                ...
                <div class="form-group form-group-sm required mmos-email">
                ...
                <div class="form-group form-group-sm <?php echo (empty($register_telephone_tax_display) && empty($register_telephone_require))  ? 'hidden' : 'required'; ?>; mmos-telephone">
                    ...
                    <input type="text" name="telephone"  id="input-register-telephone" value="" class="form-control input-sm" />
                    <?php } ?>
                </div>
            ...
            <fieldset>
                <legend class="text-<?php echo $classtheme ; ?>"><i class="fa fa-lock" style="font-size: 1.3em;"></i>&nbsp;<?php echo $text_your_password; ?></legend>
                <div class="form-group form-group-sm required mmos-password">
                ...
                <div class="form-group form-group-sm required mmos-confirm">
    ...
    <div class="panel-body"  style="border-left: 0">
        <form role="form">
            ...
            <fieldset id="address-register">
                ...
                <legend class="text-<?php echo $classtheme ; ?>"><i class="fa fa-plus text-success "  style="font-size: 1.3em;"></i> <?php echo $text_your_address; ?></legend>
                <?php } else { ?>
                <label style="display: table; cursor: pointer;">
                    <legend class="text-<?php echo $classtheme ; ?>" style="display: table-row;">

                        <div style="display: table-cell; width: 99%;">
                            <i class="fa fa-plus text-success"  style="font-size: 1.3em;"></i> <?php echo $text_your_address; ?>
                        </div>
                        <div style="display: table-cell;width: 1%;" class="mmos-use-address">
                            <?php if ($use_address) { ?>
                ...
                <div id="register-your-address" style="<?php
                     ...
                     ?>">
                    <div class="form-group form-group-sm mmos-company">
                    ...
                    <div class="form-group form-group-sm required mmos-address_1">
                    ...
                    <div class="form-group form-group-sm mmos-address_2">
                    ...
                    <div class="form-group form-group-sm required mmos-city">
                    ...
                    <div class="form-group form-group-sm mmos-postcode">
                    ...
                    <div class="form-group form-group-sm required mmos-country_id">
                    ...
                    <div class="form-group form-group-sm required mmos-zone_id">
...
<div class="row">
    ...
    <div class="col-xs-12">
        <div class="form-group form-group-sm mmos-newsletter">
            <div class="checkbox">
                <label>
                    <?php if ($newsletter) { ?>
        ...
        <div class="form-group form-group-sm mmos-shipping_address">
            <div class="checkbox">
                <label>
        ...
        <?php } ?>
        <?php if ($text_agree) { ?>
        <div class="form-group form-group-sm mmos-agree">
            <div class="checkbox">
                <label>
                    <?php if ($agree) { ?>
        ...
        <?php } ?>
            ...
            <button type="button" style="margin-bottom: -14px;"  id="button-register" class="btn btn-<?php echo $classtheme ; ?> btn-block"  style="<?php
                    if (!empty($css['common_btn_color'])) {
                        echo "background-color:{$css['common_btn_color']}!important; background-image:none;";
                        }
                        ?>"><i class="fa fa-send-o"></i>  <?php echo $button_continue; ?></button>
    ...
    <script type="text/javascript"><!--
        ...
        $(document).on('change, click', '#address-register input[name=\'use-address\']', function () {
            if ($(this).is(':checked')) {
