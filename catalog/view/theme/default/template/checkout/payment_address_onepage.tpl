...
?>">
    ...
    <div class="radio mmos-payment_address">
    ...
    <div class="radio clearfix mmos-payment_address">
...
?>">
    ...
    <form class="form-horizontal" role="form">
        ...
        <div class="form-group form-group-sm mmos-firstname">
        ...
        <div class="form-group form-group-sm mmos-lastname">
        ...
        <div class="form-group form-group-sm mmos-address_1">
        ...
        <div class="form-group form-group-sm mmos-city">
        ...
        <div class="form-group form-group-sm mmos-country_id">
        ...
        <div class="form-group form-group-sm mmos-zone_id">
        ...
        <div class="form-group<?php echo ($custom_field['required'] ? ' required' : ''); ?> form-group-sm custom-field" data-sort="<?php echo $custom_field['sort_order'] +2; ?>">
        ...
        <div class="form-group<?php echo ($custom_field['required'] ? ' required' : ''); ?> form-group-sm custom-field" data-sort="<?php echo $custom_field['sort_order'] +2; ?>">
          ...
          <div >
            ...
            <button type="button" id="button-payment-custom-field<?php echo $custom_field['custom_field_id']; ?>" data-loading-text="<?php echo $text_loading; ?>" class="btn btn-sm btn-block btn-default"><i class="fa fa-upload"></i> <?php echo $button_upload; ?></button>
