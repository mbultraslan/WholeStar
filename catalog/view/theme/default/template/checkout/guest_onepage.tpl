...
<div class="row">
        ...
        <form  role="form">
            <div id="account-guest">
                ...
                <div style="display: <?php echo (count($customer_groups) > 1 ? 'block' : 'none'); ?>;" class="form-group form-group-sm mmos-customer_group_id">
                    <legend class="text-<?php echo $classtheme;  ?>" style="font-size: 18px;"><i class="fa fa-users"></i> <?php echo $entry_customer_group; ?></legend>
                ...
                <div class="form-group form-group-sm mmos-telephone <?php
                    ...
                    <input type="text" name="telephone"  id="input-payment-telephone" value="" class="form-control input-sm" />
                    <?php } ?>
                </div>
                <div class="form-group form-group-sm mmos-fax <?php
    ...
    <div class="panel-body">
        <form  role="form">
            <div id="address-guest">
                <?php if (!$quick_checkout) { ?>
                <legend class="text-<?php echo $classtheme;  ?>" ><i class="fa fa-plus"  style="font-size: 1.5em;"></i> <?php echo $text_your_address; ?></legend>
                <?php } else { ?>
                <label style="display: table; cursor: pointer;">
                    <legend  style="display: table-row; ">
                        <div style="display: table-cell; width: 99%;">
                            <i class="fa fa-plus text-<?php echo $classtheme;  ?>""   style="font-size: 1.2em;"> <?php echo $text_your_address; ?></i>
                        </div>
                ...
                <?php foreach ($custom_fields as $custom_field) { ?>
                <?php if ($custom_field['location'] == 'address') { $custom_field['sort_order'] = $custom_field['sort_order'] -2; ?>
                <?php if ($custom_field['type'] == 'select') { ?>
                <div id="payment-custom-field<?php echo $custom_field['custom_field_id']; ?>" class="form-group custom-field" data-sort="<?php echo $custom_field['sort_order']; ?>">
                    <label class="control-label" for="input-payment-custom-field<?php echo $custom_field['custom_field_id']; ?>"><?php echo $custom_field['name']; ?></label>
                    <select name="custom_field[<?php echo $custom_field['location']; ?>][<?php echo $custom_field['custom_field_id']; ?>]" id="input-payment-custom-field<?php echo $custom_field['custom_field_id']; ?>" class="form-control input-sm">
                ...
                <div class="form-group form-group-sm mmos-shipping_address_same">
                    <div class="checkbox">
                        <label>
