...
<div id="shipping-address-options" style="<?php
    ...
    <div class="radio mmos-shipping_address">
...
<?php // if ($addresses && $trust_exist) { ?>
    <div id="shipping-existing" style="<?php if(!$use_exist) {echo 'display:none;';} ?>" class="mmos-address_id">
...
<div class="row">
    <div class="panel-footer">
        <div class="text-right">
            <input type="button" value="<?php echo $button_ok; ?>" id="button-shipping-address" class="btn btn-block btn-sm btn-<?php
