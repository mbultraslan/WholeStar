...
class ModelEbayChannelOrderDao extends Model {
    ...
    public function getOrderByEbayId($data) {
    ...
    public function existsByEbayId($ebay_order_id) {
        $result = $this->db->query("SELECT order_id from `" . DB_PREFIX . "order` WHERE ebay_order_id='". $this->db->escape($ebay_order_id) ."'")->row;
        return !empty($result['order_id']);
    }
