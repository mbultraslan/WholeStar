			...
			if($item->length > 0) {
				...
				if($variations->length > 0) {
					...
					foreach ($variationList as $variation) {
						...
						if($variation->getElementsByTagName('QuantitySold')->length > 0) {
							$QuantitySold = $variation->getElementsByTagName('QuantitySold')->item(0)->nodeValue;
							$myVariation['quantity'] = $myVariation['quantity'] - $QuantitySold;
						}
