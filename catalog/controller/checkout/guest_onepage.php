...
class ControllerCheckoutGuestOnepage extends Controller {
    ...
    public function index($render_content = false) {
        ...
        $view_data['button_ok'] = $this->model_checkout_checkout_onepage->getcheckoutLangugues('button_ok'); // </editor-fold>
        ...
        $view_data = array_merge($this->model_checkout_checkout_onepage->getcountries_zone('guest'), $view_data);
        ...
        if (version_compare(VERSION, '2.2.0.0') < 0) {
            ...
            $template = 'checkout/guest_onepage';
        }
    ...
    public function validate() {
        ...
        $this->load->model('checkout/checkout_onepage');
        $mmos_checkout = $this->model_checkout_checkout_onepage->getmainsetting();
        ...
        if (!$json) {
            ...
            if ((isset($mmos_checkout['guest_telephone_require']) && $mmos_checkout['guest_telephone_require'] == 1) && (utf8_strlen($this->request->post['telephone']) < 3) || (utf8_strlen($this->request->post['telephone']) > 32)) {
