...
class ControllerCheckoutRegisterOnepage extends Controller {
    ...
    public function index($render_content = false) {
        ...
        if (isset($this->session->data['register']['country_id'])) {
            ...
            $view_data['country_id'] = $this->config->get('config_country_id');
        }
        ...
        if (version_compare(VERSION, '2.2.0.0') < 0) {
            ...
            $template = 'checkout/register_onepage';
        }
    ...
    public function validate() {
        ...
        if (!$json) {
            ...
            if ((isset($mmos_checkout['register_telephone_require']) && $mmos_checkout['register_telephone_require'] == 1) && (utf8_strlen($this->request->post['telephone']) < 3) || (utf8_strlen($this->request->post['telephone']) > 32)) {
