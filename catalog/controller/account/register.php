...
class ControllerAccountRegister extends Controller
{
    ...
    public function validate()
    {
        ...
        foreach ($custom_fields as $custom_field) {
            ...
            if ($custom_field['custom_field_id']=='2') {
                $isValid = $this->checkVat($this->request->post['country_id'], $this->request->post['custom_field'][$custom_field['location']][$custom_field['custom_field_id']] );
                if($isValid == 'false'){
                $this->error['custom_field'][$custom_field['custom_field_id']] = 'Your VAT Number is not Valid';
            }
            }
        }
     ...
     * @return array
     */
    public function checkVat($countryCode = null , $vatNumber=null )
    {
        $this->load->model('localisation/country');
        if($this->request->get['ext']==='1') {
            $countryCode = $this->model_localisation_country->getCountry($this->request->get['country_id'])['iso_code_2'];
            $vatNumber = $this->request->get['vat'];
        }
        else {
            $countryCode = $this->model_localisation_country->getCountry($countryCode)['iso_code_2'];
        }
