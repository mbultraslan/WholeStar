...
class ControllerModuleKBMModRecentArticle extends Controller
{
    ...
    public function index($setting)
    {
	    ...
	    if (isset($setting['kbm_mod_recent_article_module'][$this->config->get('config_language_id')])) {
		    $this->data['title'] = html_entity_decode($setting['kbm_mod_recent_article_module'][$this->config->get('config_language_id')]['title'], ENT_QUOTES, 'UTF-8');
	    }
