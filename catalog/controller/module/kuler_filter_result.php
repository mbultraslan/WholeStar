...
class ControllerModuleKulerFilterResult extends Controller
{
	...
	public function index()
	{
		...
		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/module/kuler_filter_result.tpl')) {
			$this->response->setOutput($this->load->view($this->config->get('config_template') . '/template/module/kuler_filter_result.tpl', $data));
		} else {
			$this->response->setOutput($this->load->view('default/template/module/kuler_filter_result.tpl', $this->data));
		}
  	}
