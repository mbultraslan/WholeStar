...
class ModelSaleOrder extends Model {
	...
	public function changeOrderStatus($pid) {
		$query = $this->db->query("UPDATE `" . DB_PREFIX . "order` SET order_status_id = 3 WHERE order_id = ".$pid);
		return $query;
	}
}