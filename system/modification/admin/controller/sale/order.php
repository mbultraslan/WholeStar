...
class ControllerSaleOrder extends Controller {
	...
	protected function getList() {
		...
		$data['shippingstatus'] = $this->url->link('sale/order/shippingstatus', 'token=' . $this->session->data['token'], 'SSL');
		...
		$data['button_shipping_status'] = $this->language->get('button_shipping_status');
	...
	public function info() {
		...
		if ($order_info) {
            ...
            $data['templates_action'] = $this->url->link('module/emailtemplate/fetch_template', 'output=comment&token='.$this->session->data['token'], 'SSL');
	...
	public function shippingstatus() {
		...
		foreach ($orders as $order_id) {
			...
			$updateostatus = $this->model_sale_order->changeOrderStatus($order_id);
		 ...
		 $result = '<div class="alert alert-success"><i class="fa fa-check-circle"></i> Success: You have modified orders!      <button data-dismiss="alert" class="close" type="button">×</button></div>'; 
		
		 $this->response->setOutput($result);

		//$this->response->setOutput($this->load->view('sale/order_shipping_status.tpl', $data));
