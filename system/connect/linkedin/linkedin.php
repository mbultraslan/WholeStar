<?php
require_once(dirname(dirname(__FILE__))."/twitter/OAuth.php");
...
class LinkedIn {
	...
	function httpRequest($url, $auth_header, $method, $body = NULL)
	{
		...
		if(is_array($auth_header)){
		 $auth_header_arr=$auth_header;
		}else{
		 $auth_header_arr=array($auth_header);
		}
		...
		curl_setopt($curl, CURLOPT_HTTPHEADER, $auth_header_arr); // Set the headers.
